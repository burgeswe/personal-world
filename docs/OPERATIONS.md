...
(`homelab-vm`, 192.168.2.145). The remote points at the LAN-direct
Gitea URL — this is deliberate, not a workaround:

```text
origin  http://192.168.2.216:3000/rylee/personal-world.git
```
...
`http://192.168.2.145:18000` (`config/connections.json`, `base_url`)
