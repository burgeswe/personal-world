# Rylee Theme Pack — Mermaid Companion

**"She is not optional. She is the resident. The lab wouldn't be Rylee's without her. <3"**

---

## Identity

Rylee's Mermaid is a personal mascot based on Rylee's real tattoo. She serves as the digital resident, comforting companion, and status indicator across all personal servers, services, and homelab portals. In Personal World, she replaces the default World Keeper globe as the companion character.
...
When the Rylee pack is active, Personal World's accent tokens change:

| Token | Default (World Keeper) | Rylee (Mermaid) |
|---|---|---|
...
| Context | Size | Notes |
|---|---|---|
| Homepage Header | 20px accent | Beside "Rylee Lab · active services (14)" |
...
6. **[06] Resident Status** — She is not optional. She is the resident. The lab wouldn't be Rylee's without her. <3
...
*© 2026 Rylee Lab. Designed with care. Deeply personal, forever cozy.*
