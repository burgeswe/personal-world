...
| File | Description |
|---|---|
| `mermaid-source-rig-v2.svg` | **Primary deliverable** — polished, animation-ready SVG with 53+ named layer groups, Rylee palette colors, and face variants (eyes-closed, mouth-neutral) for LottieFiles rigging |
